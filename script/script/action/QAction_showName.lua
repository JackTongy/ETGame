...
local _table = {
	...
	[8] = {		f = 8,	p = {0,7},	},
	-- []
	[9] = {		f = 2*15+9,	p = {0,10},	a = 0.8000,	},
	[10] = {	f = 2*15+10,	p = {0,13},	a = 0.6000,	},
	[11] = {	f = 2*15+11,	p = {0,16},	a = 0.4000,	},
	[12] = {	f = 2*15+12,	p = {0,19},	a = 0.2000,	},
	[13] = {	f = 2*15+13,	p = {0,22},	a = 0,	},
}
