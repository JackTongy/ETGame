...
--_table.shapeMap['shape-4'] = {116, 116}
...
----- depth = 2 -----
_table.array[2] = {
	[1] = { f = 1,	p = {-337.40, 185.05},	s = {0.78, 0.78},	r = 0.00,	a = 164,	c = {255, 255, 255},	i = 'shape-4',	ar = {0.50, 0.50},	v = true },
	...
	[29] = { f = 29,	p = {-291.00, 279.90},	s = {0.58, 0.58} },
}
